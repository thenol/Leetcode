...
https://leetcode.cn/problems/find-mirror-score-of-a-string/description/?slug=maximum-subarray-with-equal-products&region=local_v2
"""

from string import ascii_lowercase
from collections import defaultdict
class Solution:
    # WA❌：错在每次只存储了最近的下标，而之前没有标记的下表被最新的下表覆盖了，丢掉了
